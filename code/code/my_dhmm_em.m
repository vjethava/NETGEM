function [LL, prior, transmat, obsmat, nrIterations, gamma] = ...
   my_dhmm_em(data, prior, transmat, obsmat, varargin)
...
if ~iscell(data)
 ...
 %%% Code modification to get gamma reported by fwdback
while (num_iter <= max_iter) & ~converged
 % E step
 [loglik, exp_num_trans, exp_num_visits1, exp_num_emit, exp_num_visitsT, gamma] = ...
     compute_ess_dhmm1(prior, transmat, obsmat, data, obs_prior_weight);
...
function [loglik, exp_num_trans, exp_num_visits1, exp_num_emit, ...
          exp_num_visitsT, gamma] = ... 
    compute_ess_dhmm1(startprob, transmat, obsmat, data, dirichlet)
