...
\section{Results}
In this manuscript, we present a graphical model to analyze temporal
expression  \todo{[describe briefly]}. \todo{[Present statistics of
  the method, efficiency, characteristics, etc. How it performed on a
  toy model.]} We used this method to analyze the dynamics of
